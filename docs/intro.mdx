...
hide_title: true
description: CLayer is a high-performance, EVM-compatible blockchain built with Delegated Proof of Stake consensus, delivering efficient throughput and security for DeFi, NFTs, and enterprise applications.
---
...
<div className="hero-gradient">
  <h1 className="hero-title">Welcome to CLayer Documentation</h1>
...
<div className="video-tutorial-section" style={{margin: "30px 0", textAlign: "center"}}>
  <div className="video-container" style={{position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden", maxWidth: "100%", backgroundColor: "#000", borderRadius: "8px"}}>
    <iframe 
      ...
      title="CLayer Smart Contract Development Tutorial" 
      frameBorder="0" 
  ...
  <div style={{marginTop: "20px", padding: "16px", backgroundColor: "var(--ifm-background-surface-color)", border: "1px solid var(--ifm-color-emphasis-200)", borderRadius: "8px"}}>
    ...
    <div style={{display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "8px", textAlign: "left"}}>
      <div>✅ Writing smart contracts for CLayer</div>
      <div>✅ Using CLayer AI for development assistance</div>
      <div>✅ Connecting MetaMask to CLayer testnet</div>
      <div>✅ Getting testnet tokens from the faucet</div>
      <div>✅ Deploying contracts using Remix IDE</div>
      <div>✅ Verifying contracts on CLayer explorer</div>
    </div>
  </div>
</div>
...
CLayer combines several cutting-edge technologies to deliver a superior blockchain experience:
...
<div className="mobile-target-cards">
  <div className="target-main-card">
    ...
    <div className="target-stats-grid">
      ...
      <div className="target-stat">
        <div className="target-stat-value">CLayer</div>
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>CLayer (Mainnet Target)</strong></td>
      <td><strong>50,000+</strong> 🎯</td>
      <td><strong>under 1s</strong></td>
      <td><strong>99.9% less</strong></td>
    </tr>
    <tr>
      <td><strong>CLayer (Testnet Development)</strong></td>
...
<div className="quick-start-grid">
  <div className="quick-start-card developer">
    ...
    <span className="card-description">Start building on CLayer</span>
...
CLayer's innovative architecture combines proven blockchain technology with cutting-edge AI security:
...
CLayer is building a comprehensive blockchain ecosystem through strategic phases:
...
<div className="next-steps">
  <div className="step-card">
    ...
    <span className="step-description">Configure MetaMask for CLayer testnet</span>
...
<div className="intro-footer-cta">
  🌟 <strong>Ready to build the future?</strong> CLayer provides the perfect foundation for your next-generation dApp.
</div> 