...
<div className={styles.hero}>
  <div className={styles.heroContent}>
    ...
    <p>Circle Layer features a progressive fee structure that automatically reduces and eventually eliminates fees as the project reaches funding milestones. Token is now live and trading on Ethereum!</p>
  </div>
</div>
