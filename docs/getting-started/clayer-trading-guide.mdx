---
sidebar_position: 4
description: CLAYER Trading Guide - How to buy and trade Core Layer tokens on Ethereum with slippage recommendations and useful links.
---
...
Core Layer (CLAYER) token is now live and trading on Ethereum mainnet. You can buy and trade CLAYER tokens freely without any restrictions.
...
### 1. **Contract Address**
**Core Layer (CLAYER)**: `0x7b5d6a651b5ea2049489123c5959b3d3cdfeee57`
...
- **Website**: [Core Layer Official](https://circlelayer.io)
