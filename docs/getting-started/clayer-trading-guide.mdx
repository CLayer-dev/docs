---
sidebar_position: 4
description: CLAYER Trading Guide - How to buy and trade CLayer tokens on Ethereum with slippage recommendations and useful links.
---
...
CLayer (CLAYER) token is now live and trading on Ethereum mainnet. You can buy and trade CLAYER tokens freely without any restrictions.
