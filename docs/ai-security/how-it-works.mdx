...
sidebar_position: 1
description: Learn About CLayer's AI-powered security features.
---
...
<div className="security-guarantee">
  <div className="guarantee-content">
    ...
    <p>CLayer's AI security system provides enterprise-grade protection with a <strong>99.9% threat detection rate</strong> and <strong>sub-second response times</strong>. Your assets and smart contracts are protected by the most advanced blockchain security technology available.</p>
