...
description: Complete guide for compiling, deploying, and configuring Core Layer blockchain nodes from source
---
...
Recommended directory structure for Core Layer node deployment:
