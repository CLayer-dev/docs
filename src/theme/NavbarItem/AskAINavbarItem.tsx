...
const AskAINavbarItem: React.FC = () => {
    ...
    const quickActions = [
        { label: "Getting Started", query: "How do I get started with CLayer?" },
        { label: "Network Info", query: "What are CLayer network specifications?" },
        { label: "Development", query: "How do I develop on CLayer?" },
    ...
    return (
        <>
            <button
                ...
                aria-label="Ask AI about CLayer"
            >
                        ...
                        <div className={styles.messagesContainer}>
                            {messages.length === 0 ? (
                                <div className={styles.emptyState}>
                                    <p>Hi! I'm your CLayer AI assistant.</p>
